package com.erkindilekci.numbermaster.viewmodel
...
class GameViewModel(
    ...
    val game = Game(
        ...
        onScoreChange = { score ->
            ...
            if (highScore.value < score) preferenceRepository.highScore =
    ...
    init {
        viewModelScope.launch {
            flow {
                ...
                .onEach {
                    preferenceRepository.timeElapsed =
                        _playTimeInSecs.updateAndGet { prev -> prev + 1 }
                }
                .collect()
        }
    }
